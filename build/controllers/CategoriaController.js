...
class CategoriaController {
    getCategoria(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const resul = yield database_1.default.query('SELECT id_categoria, categoria FROM tb_categorias');
            res.json(resul[0]);
        });
    }
    getByIdCategoria(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resul = yield database_1.default.query('SELECT id_categoria, categoria FROM tb_categorias WHERE id_categoria=?', [id_categoria]);
            res.json(resul[0]);
        });
    }
    ...
    deleteCategoria(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('DELETE FROM tb_categorias WHERE id_categoria=?', [id_categoria]);
    ...
    updateCategoria(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('UPDATE tb_categorias SET ? WHERE id_categoria= ?', [req.body, id_categoria]);
