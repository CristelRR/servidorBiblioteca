...
class CategoriaController {
    ...
    getByIdCategoria(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resul = yield database_1.default.query('SELECT * FROM tb_categorias WHERE id_categoria=?', [id_categoria]);
            res.json(resul[0]);
        });
    }
    ...
    deleteCategoria(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('DELETE FROM tb_categorias WHERE id_usuario=?', [id_categoria]);
