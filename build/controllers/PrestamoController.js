...
class PrestamoController {
    getPrestamo(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const resul = yield database_1.default.query('SELECT * FROM tb_prestamos');
            res.json(resul[0]);
        });
    }
    getByIdPrestamo(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resul = yield database_1.default.query('SELECT * FROM tb_prestamos WHERE id_prestamo=?', [id_prestamo]);
            res.json(resul[0]);
        });
    }
