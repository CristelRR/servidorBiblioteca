...
class CarreraController {
    getCarrera(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const resul = yield database_1.default.query('SELECT * FROM tb_carreras');
            res.json(resul[0]);
        });
    }
    getByIdCarrera(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resul = yield database_1.default.query('SELECT * FROM tb_carreras WHERE id_carrera=?', [id_carrera]);
            res.json(resul[0]);
        });
    }
